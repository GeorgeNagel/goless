...
// luaScript is the entire qless.lua script as a single
// string, so that it gets packaged up with any go binary
var luaScript = `-- Current SHA: 20dc687832ad472f0a00899d26c285b893ff466c
